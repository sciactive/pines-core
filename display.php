...
class module {
    /**
     * @var string $title The modules title.
     * @var string $class_suffix A suffix to append to the module's class name. Applies to HTML modules.
     * @var string $content The modules content. (Though not necessary, this should be filled using a view.)
     * @var string $component The component that the module will retrieve its content from.
     * @var string $view The view that the module will retrieve its content from.
     */
	public $title, $class_suffix, $content, $component, $view = '';
    /**
     * @var string $position The position on the page to place the module.
     * @var int $order The order the module will be placed in.
     */
    public $position, $order = null;
    /**
     * @var bool $show_title Whether the title of the module should be displayed.
     */
    ...
    /**
     * Append content to the module. Note that this may be appended before the
     * view is called, thus being placed before the content from the view.
     *
    ...
    /**
     * Retrieve the current content of the module. Note that this may not
     * include the content generated by the view if not called late enough.
     *
    ...
    /**
     * Renders the module. render() will first try to find the view in a folder
     * named as the type defined in the template, then will remove text after
     * and including the last dash in the type until it finds a view. If nothing
     * is found after the last dash is removed, it will require() the view from
     * the directory 'all'.
     *
...
class page {
     ...
     * @var string $head The head section of the page.
     * @var string $content The body section of the page.
     * @var string $footer The footer at the bottom of the page.
     * @var string $override_doc The content which will override the entire page.
     * @internal
     */
	protected $title, $head, $content, $footer, $override_doc = '';
    /**
     * @var array $notice The notices to display.
     * @var array $error The errors to display.
     * @var array $modules The moduels to display.
     * @internal
     */
