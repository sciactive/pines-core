...
cp "../trunk/pines/components/com_ptags/includes/jquery.ptags.default.css" "jquery.ptags/"
cp "../trunk/pines/components/com_ptags/includes/jquery.ptags.js" "jquery.ptags/"
