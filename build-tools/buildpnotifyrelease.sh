...
cp "../trunk/pines/components/com_pnotify/includes/jquery.pnotify.default.icons.css" "jquery.pnotify/use for pines style icons/"
cp "../trunk/pines/components/com_pnotify/includes/jquery.pnotify.default.css" "jquery.pnotify/"
cp "../trunk/pines/components/com_pnotify/includes/jquery.pnotify.js" "jquery.pnotify/"
