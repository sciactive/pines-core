...
if (!$GLOBALS['js_ptags_included']) {
	echo ("<link href=\"{$config->rela_location}system/css/jquery.ptags.default.css\" media=\"all\" rel=\"stylesheet\" type=\"text/css\" />\n");
	echo ("<script type=\"text/javascript\" src=\"{$config->rela_location}system/js/jquery.ptags.js\"></script>\n");
