...
if (!$GLOBALS['js_jstree_included']) {
	echo ("<script type=\"text/javascript\" src=\"{$config->rela_location}system/js/jquery.tree/jquery.tree.min.js\"></script>\n");
	echo ("<script type=\"text/javascript\" src=\"{$config->rela_location}system/js/jquery.tree/plugins/jquery.tree.contextmenu.js\"></script>\n");
